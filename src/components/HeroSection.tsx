...
export default function HeroSection() {
  return (
    <section className="max-w-7xl mx-auto rounded-b-3xl bg-white px-3 py-3 dark:bg-dark sm:px-6 sm:py-5 lg:px-8 lg:py-6">
      <div className="relative flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-dark-100 sm:rounded-3xl lg:min-h-[430px] lg:flex-row xl:min-h-[450px]">
        ...
        <div className="relative z-20 flex flex-col justify-center p-5 sm:p-7 md:p-9 lg:w-5/12 lg:px-10 lg:py-8 xl:px-12 xl:py-10">
          ...
          <h1 className="mb-3 text-[1.85rem] font-extrabold leading-[1.06] tracking-tight text-gray-900 dark:text-white sm:mb-4 sm:text-4xl md:text-5xl lg:text-[3rem] xl:text-[3.35rem]">
            Bring Your Imagination to Life
          </h1>
          <p className="mb-5 max-w-md text-sm font-medium text-gray-600 dark:text-gray-300 sm:mb-6 sm:text-base md:text-lg lg:mb-7 lg:text-[1.1rem]">
