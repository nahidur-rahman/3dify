  ...
  const sampleProducts: Prisma.ProductCreateInput[] = [
    {
      ...
      category: Category.COLLECTIBLES_AND_FIGURES,
    ...
    },
    {
      ...
      category: Category.DESK_ACCESSORIES,
      color: "Matte Black",
      size: "16x8x1.2 cm",
      sizeMode: "OPTIONS",
      sizeOptions: [
    ...
    },
    {
      ...
      category: Category.VASES_AND_PLANTERS,
      color: "White",
      size: "20x10x10 cm",
      sizeMode: "FIXED",
      sizeOptions: [],
    ...
    },
    {
      ...
      category: Category.CUSTOM_AND_PERSONALIZED,
      color: "Any Color",
      size: "20x5x2 cm",
      sizeMode: "OPTIONS",
      sizeOptions: [
    ...
    },
    {
      ...
      category: Category.COSPLAY_PROPS_AND_MODEL_KITS,
      color: "Red & Gold",
      size: "30x25x25 cm",
      sizeMode: "FIXED",
      sizeOptions: [],
